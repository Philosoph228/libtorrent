...
LIBTORRENT_EXPORT Object object_create_normal(const raw_bencode& obj);
LIBTORRENT_EXPORT Object object_create_normal(const raw_list& obj);
LIBTORRENT_EXPORT Object object_create_normal(const raw_map& obj);
