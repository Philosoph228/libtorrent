...
LIBTORRENT_EXPORT int ai_get_addrinfo(const char* nodename, const char* servname, const addrinfo* hints, ai_unique_ptr& res);

// Helper functions:

// TODO: Consider servname "0".
// TODO: ai_get_first_sa_err that returns a tuple?
LIBTORRENT_EXPORT sa_unique_ptr ai_get_first_sa(const char* nodename, const char* servname = nullptr, const addrinfo* hints = nullptr);

LIBTORRENT_EXPORT int ai_each_inet_inet6_first(const char* nodename, const ai_sockaddr_func& lambda);
